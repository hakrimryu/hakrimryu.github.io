...
<blockquote>
<ol>
<li> 쌀을 준비하고 쌀을 씻고 물을 넣고 (코딩) </li>
<li> 밥솥에 쌀을 넣고 취사 버튼을 누릅니다. (컴파일) </li>
<li> 취사가 끝나면 밥이 완성됩니다. (실행 파일) </li>
</ol>
</blockquote>
...
설치를 진행하시다 아래와 같은 화면에서 워크로드를 선택하여 설치 할 수 있습니다.
